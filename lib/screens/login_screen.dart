...
class _LoginForm extends StatelessWidget {
  ...
  TextFormField _textFormEmail(BuildContext context, LoginFormProvider loginForm) {
  ...
  TextFormField _textFormPassword(BuildContext context, LoginFormProvider loginForm) {
    return TextFormField(
      autocorrect: false,
      obscureText: true,
